...
grep -v "project(" | tr -s ' ' |
sort -u > teku-21.1.0_dependencies_direct.txt;

echo -e "Direct dependencies: $(cat teku-21.1.0_dependencies_direct.txt | wc -l)";

mv teku-21.1.0_dependencies_direct.txt ../../bash_scripts/build_logs/teku
