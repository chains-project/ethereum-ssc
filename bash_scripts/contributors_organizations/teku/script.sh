...
curl -u cesarsotovalero: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 --fail --silent --show-error https://api.github.com/repos/ConsenSys/teku/contributors\?per_page\=100\&page\=1\&anon\=true | jq -r '.[].organizations_url' |
grep 'https' > teku_contributors_organizations_url.txt
